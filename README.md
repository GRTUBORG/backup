...
## Быстрый перенос готового архива с сервера с бэкапами
...
Скрипт перед выполнением автоматически делает `apt-get update -y` и устанавливает зависимости: `openssh-client`, `zip`, `unzip`, `tar`.
